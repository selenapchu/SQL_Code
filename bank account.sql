...
/*Join EMPLOYEE and ACCOUNT tables and find out MAX/MIN of available balance*/
...
/*Use 'LIKE' and 'NOT LIKE' syntax to find the teller works in 2001, 2002, and 2004*/
...
/*Use 'COUNT' to aggregate the number of managers*/
...
/*Use RIGHT OUTER JOIN to combine ACCOUNT and EMPLOYEE tables and ensure all accounts are counted*/
SELECT M.lname, 
A.open_emp_id, 
